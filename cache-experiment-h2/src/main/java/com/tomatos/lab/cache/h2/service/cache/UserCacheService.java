package com.tomatos.lab.cache.h2.service.cache;
...
public class UserCacheService {
    ...
    private static final String USER_ORDERS_KEY_PREFIX = "user:";
    ...
    public List<Map<String, Object>> findUserWithOrders(Long userId) {
        String key = USER_ORDERS_KEY_PREFIX + userId + ORDERS_SUFFIX;
        String cached = redisTemplate.opsForValue().get(key);
